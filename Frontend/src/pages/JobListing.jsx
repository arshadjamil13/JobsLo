...
function JobListing() {
  ...
  const{fn:fnJobs,data:jobs,loading:loadingJobs,error:errorJob} =useFetch(getJobs,{location,searchQuery,company_id})
  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 justify-center my-5">
